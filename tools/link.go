...
func linkOne(src, dst string, dryRun, force bool, lock *lockfile) error {
...
func linkTree(domain, kind, src, dstDir string, dryRun, force bool, lock *lockfile) (int, error) {
